...
const BRANCHES = [
  'Sri Chaitanya – Hyderabad (Madhapur)',
  'Sri Chaitanya – Hyderabad (Kukatpally)',
  'Sri Chaitanya – Vijayawada',
  'Sri Chaitanya – Visakhapatnam',
  'Sri Chaitanya – Tirupati',
  'Sri Chaitanya – Guntur',
  'Sri Chaitanya – Warangal',
]
  ...
  return (
    <div className="ru-header">
      <div className="ru-logo-row">
        <span className="ru-logo-badge">R</span>
        <span className="ru-logo-text">REINVENT</span>
      </div>
      <h1 className="ru-title">Uniform Measurement<br />Calculator</h1>
      <p className="ru-subtitle">Sri Chaitanya Schools</p>
    </div>
  )
}
    ...
    <div className="ru-card">
      ...
      <div className="ru-photo-row">
        <div className="ru-photo-box">
          <div className="ru-photo-inner" />
          <p className="ru-photo-label">Height photo</p>
          <p className="ru-photo-hint">Full-length, standing straight</p>
        </div>
        <div className="ru-photo-box">
          <div className="ru-photo-inner" />
          <p className="ru-photo-label">Chest photo</p>
          <p className="ru-photo-hint">Arms slightly raised</p>
        </div>
      </div>
